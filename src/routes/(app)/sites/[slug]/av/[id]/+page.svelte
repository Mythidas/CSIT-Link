...
<div class="flex flex-col w-full h-full p-3 bg-theme-dark-200/75 rounded-md shadow-md">
  <h3 class="text-3xl pb-5">{data.av_device.hostname}</h3>
  <div class="flex space-x-0.5 text-lg">
    <div class="space-y-0.5">
      <p class="bg-theme-dark-300 px-2 py-1">OS</p>
      ...
      <p class="bg-theme-dark-300 px-2 py-1">Isolation</p>
    </div>
    <div class="space-y-0.5">
      <p class="bg-theme-dark-300 px-2 py-1">{data.av_device.os.name}</p>
      ...
      <p class="bg-theme-dark-300 px-2 py-1">{data.av_device.isolation.adminIsolated || data.av_device.isolation.selfIsolated ? "Enabled" : "Disabled"}</p>
    </div>
  </div>
</div>